...
void CreateMonMidele(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV, const u8 *evs, u8 nature, u8 abilityNumber, u8 shiny, u8 friendship, u8 hpType, u8 genderValue);
// NUEVO PARA CUSTOM TRAINER
...
void SetMonMoveSlotWithoutResettingPP(struct Pokemon *mon, u16 move, u8 slot);
...
u8 GetNumberOfLearnableEggMoves(struct Pokemon *mon);
u8 GetTotalNumberOfEggMoves(struct Pokemon *mon);
