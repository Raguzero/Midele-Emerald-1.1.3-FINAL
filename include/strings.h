...
extern const u8 gText_Var1EVsAreWastedDoYouWantToConfirmThisEVSpread[];
extern const u8 gText_UnassignedEVsVar1[];
extern const u8 gText_WastedEVsInThisStatVar1[];
...
extern const u8 gText_SacredAshAndPrice[];
extern const u8 gText_PPMaxAndPrice[];
extern const u8 gText_LeftoversAndPrice[];
extern const u8 gText_FocusSashAndPrice[];
...
extern const u8 gEasyChatGroupName_Move3[];
extern const u8 gEasyChatGroupName_Pokemon3[];
