...
#define FLAG_CAUGHT_REGIELE  0x270 // Previously unused Flag
#define FLAG_DEFEATED_REGIELE  0x271 // Previously unused Flag
#define FLAG_HIDE_REGIELE  0x272 // Previously unused Flag
...
#define FLAG_SYS_BRAILLE_REGELE_COMPLETED                           (SYSTEM_FLAGS + 0x2F) // Previously unused Flag
