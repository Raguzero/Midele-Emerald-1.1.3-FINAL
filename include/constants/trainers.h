...
#define TRAINER_CLASS_DEBUG          0x42
...
#define TRAINER_ENCOUNTER_PACOCHEF_FIERY_PATH        14
...
#define F_TRAINER_PARTY_CUSTOM_MIDELE  (1 << 2) // NUEVO PARA CUSTOM TRAINER
