...
static const u8 sMonFrontAnimIdsTable[] =
{
    ...
    [SPECIES_EELEKTRIK - 1] = 0x02,
    [SPECIES_EELEKTROSS - 1] = 0x02,
    ...
    [SPECIES_HERDIER - 1] = 0x28,
    [SPECIES_STOUTLAND - 1] = 0x28,
...
#define MUSICOTE(a, b) { const u8 nombre[] = _(a); if (!StringCompare(gTrainers[gTrainerBattleOpponent_A].trainerName, nombre)) return b; }
    ...
    MUSICOTE("LTSURGE", MUS_RG_VS_GYM)
