...
static const u8 sText_RedHPJEeveeto[] = _("Estás a esto de ganar, pero el frío\n te lo va a impedir.\p");
...
static const u8 sText_GoldiePierdePrimerPoke[] = _("¡Apenas estamos empezando!\n¡Verás cuando saque a mi RESHIRAM\l de nivel 100!\p");
static const u8 sText_GoldieEnviaUltimoPoke[] = _("¡Mierda, me he dejado a mi\nRESHIRAM en casa!\p");
...
static const u8 sText_DarkibuenroPierdePrimerPoke[] = _("Vaya, eres fuerte,\nsi sigues así tendrás el honor\l de ver mi gran ataque especial.\l nyeh heh heh\p");
static const u8 sText_DarkibuenroEnviaUltimoPoke[] = _("Lo verás, mi fantabuloso y nuevo\n Ataque Midelar!\p");
static const u8 sText_RedHPDarkibuenro[] = _("Diantres.\n No contaba con que no tengo ese\l movimiento. nyoh hoh hoh\p");
static const u8 sText_DarkimalroPierdePrimerPoke[] = _("Tsk, eso fue un golpe de suerte, si ese\n pingüino no me hubiera atado\l a la normas de este mundo...\p");
static const u8 sText_DarkimalroEnviaUltimoPoke[] = _("¿Qué? ¡Esto es imposible!\nPulga molesta, te aplastaré...\p");
static const u8 sText_RedHPDarkimalro[] = _("Mi odio me hara prevalecer.\n ¡Ya lo verás!\p");
...
static const u8 sText_GoosesPierdePrimerPoke[] = _("Fufufufu, qué divertido.\nPero ahora viene la ventisca, criatura.\p");
static const u8 sText_GoosesEnviaUltimoPoke[] = _("Sí, muy bien.\nMuéstrame tu determinación.\p");
static const u8 sText_RedHPGooses[] = _("¡Ahahaha! Aún no he acabado.\n¡Soy la ejecutora, no cantes victoria\lhasta el final!\p");
static const u8 sText_RaguPierdePrimerPoke[] = _("¿Cómo pudo ser?\nParecen fuegos de artificio...\p");
static const u8 sText_RaguEnviaUltimoPoke[] = _("¡Este combate está que echa chispas!\p");
static const u8 sText_RedHPRagu[] = _("¡Wouhouhouhou!\n¡Una batalla realmente furiosa!\p");
...
static const u8 sText_MicoloFinalEnviaUltimoPoke[] = _("¡Adelante, humíllalos como sabes!\p");
...
static const u8 frase2[] = _("En primer lugar dar las gracias\n a mis 6 Pokemon\p(me arriesgué a usar 1 solo equipo\nen tooooodo el torneo, y el equipo\lme respondió bien, demostrando ser un\lgran equipo bastante equilibrado, y\l poderoso tanto en ataque\lcomo en defensa).\p");
static const u8 frase3[] = _("¡Gracias Hippowdon! ¡Gracias Skarmory!\n¡Gracias Tentacruel!¡Gracias Cradily!\l¡Gracias Spiritomb! ¡Gracias Garchomp!\p");
static const u8 frase4[] = _("La Primera Ronda era una fase de\n16 grupos con 3 personas cada una;\ly a mi me tocó uno de los grupos\lmas chungos: Azul, Arbok, y Naruto16.\p");
static const u8 frase5[] = _("Mi primer combate fue contra uno de los\nfavoritos para ganar el torneo: Azul,\l el subcampeón del último torneo\l de Mundogamers.\pLogré derrotarle (4-0) gracias a\nque 4 Pokemon de su equipo eran\ldébiles a Terremoto.\p");
static const u8 frase6[] = _("Mi siguiente combate fue contra Arbok,\nquien me lo puso bastante difícil con\lsu Infernape asesino:\lpero logré derrotarle(2-0).\p");
static const u8 frase7[] = _("Por ultimo, me enfrenté a Naruto16,\nen teoría el rival mas débil del grupo.\p Pero me pilló desprevenido con un\ncombo de Vaporeon y Alakazam; y acabé\lsiendo completamente aniquilado por\lun Alakazam con +6 de Defensa,\lDefensa Especial y\lAtaque Especial (0-5).\p");
static const u8 frase8[] = _("Aun asi, pasé como lider de grupo, ya\nque pese a estar empatado con Azul, le\lderroté en nuestro combate directo.\p");
static const u8 frase9[] = _("La Segunda Ronda era otra fase de\ngrupos (8) con 3 personas.\p");
static const u8 frase10[] = _("Mi primer combate fue contra Takei, y\nfue el combate mas loco\lde todo el torneo.\pPrimero su Lucario feo que me hizo\nGolpe Critico 3 veces en 4 turnos y\lcon el que mató a mitad de mi equipo.\lLuego su Forretress fallando\lExplosión e inmolandose solo.\p");
static const u8 frase11[] = _("Al final nos quedaban\nsolo nuestros Garchomps, pero en ese\lmomento Colchonero me habló y pasó su\lemoness a mi Garchomp, que se suicidó,\lpor lo que perdí (0-1).\p");
static const u8 frase12[] = _("Luego mi siguiente rival era ¡Malekith!\pFue un combate difícil donde si perdía,\ndecía adiós al torneo.\pFinalmente decidí arriesgarme con mi\nHippo, y me salió bien la jugada\l(si no llego a jugarmela perdía),\lpor lo que logré matar a su\lsorprendente Cacturne y ganar(2-0).\p");
static const u8 frase13[] = _("Mi ultimo rival era Karlos,\ny todavia podia ser eliminado.\pDesgraciadamente, Karlos fue la nota\nnegativa de mi viaje en este torneo:\lno me explico como alguien que ha\lpasado la segunda ronda le da por\lpasar del torneo y\lno luchar contra nadie.\p");
static const u8 frase14[] = _("Pasó el límite de fecha, y Karlos por\nno echar ningún combate fue\ldescalificado, por lo que a todos\lnosotros se nos dió por ganado\lel combate contra él (6-0).\p");
static const u8 frase15[] = _("En serio, para hacer lo que ha hecho,\nmejor que no se apunte a\lningún otro torneo.\pTakei, Malekith y yo estabamos con un\ntriple empate; pasamos Malekith como\l1º de grupo, y yo como 2º de grupo\lpor el average.\p");
static const u8 frase16[] = _("Llegaron los octavos, ¡y toma ya!\nMe tocó el gran favorito para llevarse\lel torneo: MDragon.\pEn ese momento me entraron\nganas de cortarme las venas xD.\p");
static const u8 frase17[] = _("Para mi sorpresa, gané el combate\ntan intenso que tuvimos (3-0).\lDe hecho, MDragon se equivocó a la\lhora de coger un Gyarados\l(tenía dos, uno ofensivo y\luno defensivo).\pSe cogió por error el defensivo,\ny eso me permitió ganarle.\p");
static const u8 frase18[] = _("Luego en una revancha se cogió el\nofensivo, y me barrió 3-0.\pSi hubiese cogido el Gyarados\nbueno desde un principio jamás\lhabría pasado ToT\p");
static const u8 frase19[] = _("Despues llegó mi combate de cuartos\ncontra Darix; que se empeñaba en jugar\lal mejor de 3, y yo al mejor de 1.\pLo hablamos con los organizadores\ny decidieron que fuese al mejor de 1.\p");
static const u8 frase20[] = _("Fue un combate largo y con mucho stall,\ndonde gracias a Trampa Rocas\ldesestabilizé su stall\lTogekiss+Forretress, y gané (2-0).\p");
static const u8 frase21[] = _("Luego llegaron las semifinales contra\nMaestro Lagarto que llegaba invicto.\pLogré desarrollar mi juego como quería\ny poner 1 Trampa Rocas, 2 Puas Toxicas,\ly 3 Puas\l(tambien ayudó que sacrificase tan\lpronto a su Tyranitar).\p");
static const u8 frase22[] = _("Logré anularle su juego en este\ncombate que fue de stall puro, y me\limpuse 6-3, entonces tras hora y media\lde combate Lagarto dijo que se tenia\lque ir y me daba por ganado el combate\l(6-0).\p");
static const u8 frase23[] = _("Finalmente la final contra Torete; la\ngran revelación del torneo. Torete\lllegaba invicto a la final, tras eliminar\lcontra todo pronostico a Shiyo,\lColchonero y Malekith.\p");
static const u8 frase24[] = _("Era hora de ver\nque estilo ganaría: su estilo\lultra-ofensivo, o mi estilo\lultra-defensivo. Y de hecho fue un\lcombate duro que se pusó en mi contra\ldurante cierta parte del combate.\p"); 
static const u8 frase25[] = _("Pero entonces, el espíritu de Shiyo que\nansiaba vengarse me dió toda su hax, y\lel Colmillo Hielo de Hippowdon le\lcongeló a su Lucario en una jugada que\lpusó la partida a mi favor. Finalmente,\lmi Pokémon favorito, Garchomp, dió el\lultimo golpe a su Breelom y gané la\lfinal (3-0).\p");
static const u8 frase26[] = _("Aqui la historia. Jugué 10 combates, los\ncuales gané 7, perdí 2, y ''empaté'' 1\l(el combate que a Karlos\lno le dió la gana jugar).\p"); 
static const u8 frase27[] = _("Los ajustes que les hice a mi\nequipo antes de empezar el torneo\lfueron de gran ayuda (antes jugué otro\ltorneo de 16 personas donde perdí mis\l3 combates de la 1ª ronda por paliza; y\lme di cuenta de que el fallo ehstaba en\lque no tenia nada para atacar.\p");
const u8 * const arena[28] = {frase0, frase1, frase2, frase3, frase4, frase5, frase6, frase7, frase8, frase9, frase10, frase11, frase12, frase13, frase14, frase15, frase16, frase17, frase18, frase19, frase20, frase21, frase22, frase23, frase24, frase25, frase26, frase27};
...
{
    MOVE_BIND, MOVE_WRAP, MOVE_FIRE_SPIN, MOVE_CLAMP, MOVE_WHIRLPOOL, MOVE_SAND_TOMB, MOVE_THUNDER_CAGE, 0xFFFF
};
...
static const u8 sATypeMove_Table[][17] =
{
    ...
    _("a DRAGON move"),
    _("a DARK move"),
    _("a FAIRY move") // NUEVO TIPO HADA
};
...
static const struct TrainerSlide sTrainerSlides[] =
{
    ...
    {TRAINER_KEFKY, sText_KefkyEnviaUltimoPoke, sText_RedHPKefky, sText_KefkyPierdePrimerPoke},
...
bool32 ShouldDoTrainerSlide(u32 battlerId, u32 trainerId, u32 which)
{
	...
	if (trainerId == TRAINER_MAESTRO_ARENA && which == TRAINER_SLIDE_LAST_LOW_HP) {
		gBattleStruct->trainerSlideMsg = arena[gBattleResults.battleTurnCounter % 28];
        return TRUE;
    }
