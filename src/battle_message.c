...
static const u8 frase2[] = _("La Primera Ronda era una fase de\n16 grupos con 3 personas cada una;\ly a mi me tocó uno de los grupos\lmas chungos: Azul, Arbok, y Naruto16.\p Mi primer combate fue contra uno de los\nfavoritos para ganar el torneo: Azul,\l el subcampeón del último torneo\l de Mundogamers.\pLogré derrotarle (4-0) gracias a\nque 4 Pokemon de su equipo eran\ldébiles a Terremoto.\p");
static const u8 frase3[] = _("Mi siguiente combate fue contra Arbok,\nquien me lo puso bastante dificil con\lsu Infernape asesino:\lpero logré derrotarle(2-0).\p");
static const u8 frase4[] = _("Por ultimo, me enfrenté a Naruto16,\nen teoría el rival mas débil del grupo.\p Pero me pilló desprevenido con un\ncombo de Vaporeon y Alakazam; y acabé\lsiendo completamente aniquilado por\lun Alakazam con +6 de Defensa,\lDefensa Especial y\lAtaque Especial (0-5).\pAun asi, pasé como lider de grupo, ya\nque pese a estar empatado con Azul, le\lderroté en nuestro combate directo.\p");
static const u8 frase5[] = _("La Segunda Ronda era otra fase de\ngrupos (8) con 3 personas.\p");
static const u8 frase6[] = _("Mi primer combate fue contra Takei, y\nfue el combate mas loco\lde todo el torneo.\pPrimero su Lucario feo que me hizo\nGolpe Critico 3 veces en 4 turnos y\lcon el que mató a mitad de mi equipo.\lLuego su Forretress fallando\lExplosión e inmolandose solo.\pAl final nos quedaban\nsolo nuestros Garchomps, pero en ese\lmomento Colchonero me habló y pasó su\lemoness a mi Garchomp, que se suicidó,\lpor lo que perdí (0-1).\p");
static const u8 frase7[] = _("Luego mi siguiente rival era ¡Malekith!\pFue un combate dificil donde si perdía,\ndecía adiós al torneo.\pFinalmente decidí arriesgarme con mi\nHippo, y me salió bien la jugada\l(si no llego a jugarmela perdía),\lpor lo que logré matar a su\lsorprendente Cacturne y ganar(2-0).\p");
static const u8 frase8[] = _("Mi ultimo rival era Karlos,\ny todavia podia ser eliminado.\pDesgraciadamente, Karlos fue la nota\nnegativa de mi viaje en este torneo:\lno me explico como alguien que ha\lpasado la segunda ronda le da por\lpasar del torneo y\lno luchar contra nadie.\pPasó el limite de fecha, y Karlos por\nno echar ningún combate fue\ldescalificado, por lo que a todos\lnosotros se nos dió por ganado\lel combate contra él (6-0).\p");
static const u8 frase9[] = _("En serio, para hacer lo que ha hecho,\nmejor que no se apunte a\lningún otro torneo.\pTakei, Malekith y yo estabamos con un\ntriple empate; pasamos Malekith como\l1º de grupo, y yo como 2º de grupo\lpor el average.\p");
static const u8 frase10[] = _("Llegaron los octavos, ¡y toma ya!\nMe tocó el gran favorito para llevarse\lel torneo: MDragon.\pEn ese momento me entraron\nganas de cortarme las venas xD.\pPara mi sorpresa, gané el combate\ntan intenso que tuvimos (3-0).\lDe hecho, MDragon se equivocó a la\lhora de coger un Gyarados\l(tenía dos, uno ofensivo y\luno defensivo).\pSe cogió por error el defensivo,\ny eso me permitió ganarle.\p");
static const u8 frase11[] = _("Luego en una revancha se cogió el\nofensivo, y me barrió 3-0.\pSi hubiese cogido el Gyarados\nbueno desde un principio jamás\lhabría pasado ToT\p");
static const u8 frase12[] = _("Despues llegó mi combate de cuartos\ncontra Darix; que se empeñaba en jugar\lal mejor de 3, y yo al mejor de 1.\pLo hablamos con los organizadores\ny decidieron que fuese al mejor de 1.\pFue un combate largo y con mucho stall,\ndonde gracias a Trampa Rocas\ldesestabilizé su stall\lTogekiss+Forretress, y gané (2-0).\p");
static const u8 frase13[] = _("Luego llegaron las semifinales contra\nMaestro Lagarto que llegaba invicto.\pLogré desarrollar mi juego como quería\ny poner 1 Trampa Rocas, 2 Puas Toxicas,\ly 3 Puas\l(tambien ayudó que sacrificase tan\lpronto a su Tyranitar).\pLogré anularle su juego en este\ncombate que fue de stall puro, y me\limpuse 6-3, entonces tras hora y media\lde combate Lagarto dijo que se tenia\lque ir y me daba por ganado el combate\l(6-0).\p");
static const u8 frase14[] = _("Finalmente la final contra Torete; la\ngran revelación del torneo. Torete\lllegaba invicto a la final, tras eliminar\lcontra todo pronostico a Shiyo,\lColchonero y Malekith. Era hora de ver\lque estilo ganaría: su estilo\lultra-ofensivo, o mi estilo\lultra-defensivo. Y de hecho fue un\lcombate duro que se pusó en mi contra\ldurante cierta parte del combate.\p"); 
static const u8 frase15[] = _("Pero entonces, el espíritu de Shiyo que\nansiaba vengarse me dió toda su hax, y\lel Colmillo Hielo de Hippowdon le\lcongeló a su Lucario en una jugada que\lpusó la partida a mi favor. Finalmente,\lmi Pokemon favorito, Garchomp, dió el\lultimo golpe a su Breelom y gané la\lfinal (3-0).\p");
static const u8 frase16[] = _("Aqui la historia. Jugué 10 combates, los\ncuales gané 7, perdí 2, y ''empaté'' 1\l(el combate que a Karlos\lno le dió la gana jugar).\p"); 
static const u8 frase17[] = _("Los ajustes que les hice a mi\nequipo antes de empezar el torneo\lfueron de gran ayuda (antes jugué otro\ltorneo de 16 personas donde perdí mis\l3 combates de la 1ª ronda por paliza; y\lme di cuenta de que el fallo ehstaba en\lque no tenia nada para atacar.\lEntonces sustituí a Blissey por\lGarchomp; y como mi equipo sería un\lSandstorm team, cambié a Tangrowth por\lCradily).\p");
const u8 * const arena[18] = {frase0, frase1, frase2, frase3, frase4, frase5, frase6, frase7, frase8, frase9, frase10, frase11, frase12, frase13, frase14, frase15, frase16, frase17};
