...
const u8 gText_ExpandedPlaceholder_Rival[] = _("RIVAL");
...
const u8 gText_NameMidele[] = _("Midele");
const u8 gText_NameMideleUppercase[] = _("MIDELE");
const u8 gText_NameSapph[] = _("Sapph");
const u8 gText_NameSapphUppercase[] = _("SAPPH");
...
const u8 gText_Var1EVsAreWastedDoYouWantToConfirmThisEVSpread[] = _("{STR_VAR_1} EVs are wasted throughout the stats.\nDo you want to confirm this EV spread?");
const u8 gText_UnassignedEVsVar1[] = _("Unassigned EVs: {STR_VAR_1}");
const u8 gText_WastedEVsInThisStatVar1[] = _("Wasted EVs in this\nstat: {STR_VAR_1}");
...
const u8 gText_FlashDarki[] = _("Mortal, nada iluminará este lugar");
...
const u8 gText_SacredAshAndPrice[] = _("SACRED ASH{CLEAR_TO 0x48}¥9000");
const u8 gText_PPMaxAndPrice[] = _("PP MAX{CLEAR_TO 0x48}¥12000");
const u8 gText_LeftoversAndPrice[] = _("LEFTOVERS{CLEAR_TO 0x48}¥15000");
const u8 gText_FocusSashAndPrice[] = _("FOCUS SASH{CLEAR_TO 0x48}¥20000");
...
const u8 gText_50CoinsAndPriceMidele[] = _("  50 COINS    ¥750");
const u8 gText_500CoinsAndPriceMidele[] = _("500 COINS  ¥7500");
...
const u8 gText_KissPoster16BP[] = _("KISS POSTER{CLEAR_TO 0x5E}3BP");
const u8 gText_KissCushion32BP[] = _("KISS CUSHION{CLEAR_TO 0x5E}5BP");
const u8 gText_SmoochumDoll32BP[] = _("SMOOCHUM DOLL{CLEAR_TO 0x5E}5BP");
const u8 gText_TogepiDoll48BP[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}5BP");
const u8 gText_MeowthDoll48BP[] = _("MEOWTH DOLL{CLEAR_TO 0x5E}5BP");
const u8 gText_ClefairyDoll48BP[] = _("CLEFAIRY DOLL{CLEAR_TO 0x5E}5BP");
const u8 gText_DittoDoll48BP[] = _("DITTO DOLL{CLEAR_TO 0x5E}5BP");
...
const u8 gText_LaprasDoll128BP[] = _("LAPRAS DOLL{CLEAR_TO 0x58}15BP");
const u8 gText_SnorlaxDoll128BP[] = _("SNORLAX DOLL{CLEAR_TO 0x58}15BP");
const u8 gText_VenusaurDoll256BP[] = _("VENUSAUR DOLL{CLEAR_TO 0x58}15BP");
const u8 gText_CharizardDoll256BP[] = _("CHARIZARD DOLL{CLEAR_TO 0x58}15BP");
const u8 gText_BlastoiseDoll256BP[] = _("BLASTOISE DOLL{CLEAR_TO 0x58}15BP");
...
const u8 gText_BrightPowder64BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}12BP");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}12BP");
const u8 gText_ChoiceScarf64BP[] = _("CHOICE SCARF{CLEAR_TO 0x5E}12BP");
const u8 gText_ChoiceSpecs64BP[] = _("CHOICE SPECS{CLEAR_TO 0x5E}12BP");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}12BP");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}12BP");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}12BP");
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 0x4E}");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 0x4E}");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 0x4E}");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 0x4E}");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 0x4E}");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 0x4E}");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 0x4E}");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 0x4E}");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 0x4E}");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 0x4E}");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x4E}");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 0x4E}");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 0x4E}");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}");
...
const u8 gEasyChatGroupName_Move3[] = _("MOVE 3");
const u8 gEasyChatGroupName_Pokemon3[] = _("POKéMON3");
