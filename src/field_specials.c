...
u8 GetLeadMonFriendshipScore(void)
{
    ...
    ConvertUIntToDecimalStringN(gStringVar1, GetMonData(pokemon, MON_DATA_FRIENDSHIP), STR_CONV_MODE_LEFT_ALIGN, 3);
...
void PCBatallaGivePrize(void)
{
    static const u16 PC_Batalla_Items[][7] = {
        ...
        {TRAINER_RED2, 5, ITEM_LUCKY_EGG, ITEM_AMULET_COIN, ITEM_EXP_SHARE, ITEM_NUGGET, ITEM_MACHO_BRACE},
        {TRAINER_LEAF2, 5, ITEM_LUCKY_EGG, ITEM_AMULET_COIN, ITEM_EXP_SHARE, ITEM_NUGGET, ITEM_MACHO_BRACE},								
        {TRAINER_CHERYL, 5, ITEM_NUGGET, ITEM_RARE_CANDY, ITEM_RARE_CANDY, ITEM_NUGGET, ITEM_LEFTOVERS},	
		{0}
    };
