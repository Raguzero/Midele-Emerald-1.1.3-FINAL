...
static void MusicPlayer_SelectSong(u8 taskId)
{
    ...
    if (gMain.newKeys & DPAD_ANY)
    {
        ...
        StringCopyMultilinePadded(gStringVar1, sMusicNames[musicTable[currentMusicTableId]], CHAR_SPACE, MUSIC_PLAYER_MAIN_MENU_WIDTH + MUSIC_PLAYER_DISPLAY_WIDTH + 5, 2);
