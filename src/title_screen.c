...
#define VERSION_BANNER_Y_GOAL 90
...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/mideletitle.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/mideletitle.bin.lz");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(CRUELANGELSTHESIS);
        gMain.state = 5;
        break;
    case 5:
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    else
    {
        ...
        CreateCopyrightBanner(START_BANNER_X, 157);
