...
static const u16 sMoves_TotalPreparation[] =
{
    ...
    MOVE_CHARGE, MOVE_SNATCH, MOVE_TAIL_GLOW, MOVE_COSMIC_POWER, MOVE_IRON_DEFENSE, MOVE_HOWL, MOVE_BULK_UP, MOVE_CALM_MIND, MOVE_DRAGON_DANCE, MOVE_NASTY_PLOT, MOVE_COIL, MOVE_QUIVER_DANCE, MOVE_ROCK_POLISH,
    MOVE_NONE
};
...
static const u16 sMoves_HighRiskHighReturn[] =
{
    ...
    MOVE_BLAST_BURN, MOVE_HYDRO_CANNON, MOVE_OVERHEAT, MOVE_FRENZY_PLANT, MOVE_PSYCHO_BOOST, MOVE_VOLT_TACKLE, MOVE_BRAVE_BIRD, MOVE_HEAD_SMASH, MOVE_LIGHT_OF_RUIN, MOVE_LEAF_STORM,
    MOVE_NONE
};
...
static const u16 sMoves_Endurance[] =
{
    ...
    MOVE_MUD_SPORT, MOVE_SLACK_OFF, MOVE_AROMATHERAPY, MOVE_WATER_SPORT, MOVE_SHORE_UP,
    MOVE_NONE
};
