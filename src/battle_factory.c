...
static const u16 sMoves_HighRiskHighReturn[] =
{
    ...
    MOVE_BLAST_BURN, MOVE_HYDRO_CANNON, MOVE_OVERHEAT, MOVE_FRENZY_PLANT, MOVE_PSYCHO_BOOST, MOVE_VOLT_TACKLE, MOVE_BRAVE_BIRD, MOVE_HEAD_SMASH, MOVE_LIGHT_OF_RUIN,
    MOVE_NONE
};
