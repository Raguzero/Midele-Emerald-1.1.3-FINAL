...
const u32 gTrainerFrontPic_Lavender[] = INCBIN_U32("graphics/trainers/front_pics/lavender_front_pic.4bpp.lz");
const u32 gTrainerPalette_Lavender[] = INCBIN_U32("graphics/trainers/palettes/lavender.gbapal.lz");
