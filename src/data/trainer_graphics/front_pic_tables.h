const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_NERD_HGSS] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_DOCTOR] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_GOLDIE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_KEFKY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_MERUM] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ENTROPIA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SCIENTISH_FRLG] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_MICOLO] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CHANNELER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CURSED_SLOWBRO] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RANDOM] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_OFFICER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_TAMER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_JUGON] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_VIN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_GOOSES] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ROCKER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_DARKIMALRO] = {.size = 8, .y_offset = 1},
	...
	[TRAINER_PIC_SAPPH] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_MAUS] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_SOLDIER_MIKU] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_MEIKO] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_LUKA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_MIKU] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_DOOD] = {.size = 8, .y_offset = 1},
	...
	[TRAINER_PIC_LAEX] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(NERD_HGSS, gTrainerFrontPic_NerdHgss, 0x800),
    TRAINER_SPRITE(BROCK, gTrainerFrontPic_Brock, 0x800),
    TRAINER_SPRITE(MISTY, gTrainerFrontPic_Misty, 0x800),
    TRAINER_SPRITE(LT_SURGE, gTrainerFrontPic_Lt_Surge, 0x800),
    ...
    TRAINER_SPRITE(DOCTOR, gTrainerFrontPic_Doctor, 0x800),
    TRAINER_SPRITE(GOLDIE, gTrainerFrontPic_Goldie, 0x800),
    TRAINER_SPRITE(KEFKY, gTrainerFrontPic_Kefky, 0x800),
    TRAINER_SPRITE(MERUM, gTrainerFrontPic_Merum, 0x800),
    TRAINER_SPRITE(ENTROPIA, gTrainerFrontPic_Entropia, 0x800),
    TRAINER_SPRITE(SCIENTISH_FRLG, gTrainerFrontPic_scientish_frlg, 0x800),
    TRAINER_SPRITE(MICOLO, gTrainerFrontPic_Micolo, 0x800),
    TRAINER_SPRITE(CHANNELER, gTrainerFrontPic_Channeler, 0x800),
    TRAINER_SPRITE(CURSED_SLOWBRO, gTrainerFrontPic_CursedSlowbro, 0x800),
    TRAINER_SPRITE(RANDOM, gTrainerFrontPic_RandomBot, 0x800),
	TRAINER_SPRITE(OFFICER, gTrainerFrontPic_Officer, 0x800),
	TRAINER_SPRITE(TAMER, gTrainerFrontPic_Tamer, 0x800),
	TRAINER_SPRITE(JUGON, gTrainerFrontPic_Jugon, 0x800),
	TRAINER_SPRITE(VIN, gTrainerFrontPic_Vin, 0x800),
	TRAINER_SPRITE(GOOSES, gTrainerFrontPic_Gooses, 0x800),
	TRAINER_SPRITE(ROCKER, gTrainerFrontPic_Rocker, 0x800),
	TRAINER_SPRITE(DARKIMALRO, gTrainerFrontPic_Darkimalro, 0x800),
	...
	TRAINER_SPRITE(SAPPH, gTrainerFrontPic_Sapph, 0x800),
	TRAINER_SPRITE(MAUS, gTrainerFrontPic_Maus, 0x800),
	TRAINER_SPRITE(SOLDIER_MIKU, gTrainerFrontPic_SoldierMiku, 0x800),
	TRAINER_SPRITE(MEIKO, gTrainerFrontPic_Meiko, 0x800),
	TRAINER_SPRITE(LUKA, gTrainerFrontPic_Luka, 0x800),
	TRAINER_SPRITE(MIKU, gTrainerFrontPic_Miku, 0x800),
	TRAINER_SPRITE(DOOD, gTrainerFrontPic_Dood, 0x800),
	...
	TRAINER_SPRITE(LAEX, gTrainerFrontPic_Laex, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(NERD_HGSS, gTrainerPalette_NerdHgss),
    TRAINER_PAL(BROCK, gTrainerPalette_Brock),
    TRAINER_PAL(MISTY, gTrainerPalette_Misty),
    TRAINER_PAL(LT_SURGE, gTrainerPalette_Lt_Surge),
    ...
    TRAINER_PAL(DOCTOR, gTrainerPalette_Doctor),
    TRAINER_PAL(GOLDIE, gTrainerPalette_Goldie),
    TRAINER_PAL(KEFKY, gTrainerPalette_Kefky),
    TRAINER_PAL(MERUM, gTrainerPalette_Merum),
    TRAINER_PAL(ENTROPIA, gTrainerPalette_Entropia),
    TRAINER_PAL(SCIENTISH_FRLG, gTrainerPalette_scientish_frlg),
    TRAINER_PAL(MICOLO, gTrainerPalette_Micolo),
    TRAINER_PAL(CHANNELER, gTrainerPalette_Channeler),
    TRAINER_PAL(CURSED_SLOWBRO, gTrainerPalette_CursedSlowbro),
    TRAINER_PAL(RANDOM, gTrainerPalette_RandomBot),
    TRAINER_PAL(OFFICER, gTrainerPalette_Officer),
    TRAINER_PAL(TAMER, gTrainerPalette_Tamer),
    TRAINER_PAL(JUGON, gTrainerPalette_Jugon),
    TRAINER_PAL(VIN, gTrainerPalette_Vin),
    TRAINER_PAL(GOOSES, gTrainerPalette_Gooses),
    TRAINER_PAL(ROCKER, gTrainerPalette_Rocker),
    TRAINER_PAL(DARKIMALRO, gTrainerPalette_Darkimalro),
    ...
    TRAINER_PAL(SAPPH, gTrainerPalette_Sapph),
    TRAINER_PAL(MAUS, gTrainerPalette_Maus),
    TRAINER_PAL(SOLDIER_MIKU, gTrainerPalette_SoldierMiku),
    TRAINER_PAL(MEIKO, gTrainerPalette_Meiko),
    TRAINER_PAL(LUKA, gTrainerPalette_Luka),
    TRAINER_PAL(MIKU, gTrainerPalette_Miku),
    TRAINER_PAL(DOOD, gTrainerPalette_Dood),
	...
	TRAINER_PAL(LAEX, gTrainerPalette_Laex),
};
