...
{
    MENU_SUMMARY,
	MENU_INFODEX, // NUEVO PARA INFODEX EN EQUIPO (ENTRAR A LA DEX DEL POKE EN CUESTION)
    MENU_SWITCH,
    MENU_CANCEL1,
    MENU_ITEM,
    MENU_GIVE,
...
} static const sCursorOptions[] =
{
	...
	[MENU_INFODEX] = {gText_InfoDex, CursorCb_InfoDex}, // NUEVO PARA INFODEX EN EQUIPO (ENTRAR A LA DEX DEL POKE EN CUESTION)
...
static const u16 sFieldMoves[] =
{
    ...
    MOVE_WATERFALL,
    MOVE_DIVE,
    MOVE_TELEPORT, MOVE_DIG, MOVE_SECRET_POWER, MOVE_MILK_DRINK, MOVE_SOFT_BOILED, MOVE_SWEET_SCENT, FIELD_MOVE_TERMINATOR
};

static const u16 sFieldMovesHMs[] = 
{
    ITEM_HM02_FLY,
    ITEM_HM05_FLASH,
    ITEM_HM01_CUT,
...
static const u16 sFieldMovesFlags[] = 
{
    [FIELD_MOVE_CUT] = FLAG_RECEIVED_HM01,
    [FIELD_MOVE_FLY] = FLAG_RECEIVED_HM02,
    [FIELD_MOVE_SURF] = FLAG_RECEIVED_HM03,
    [FIELD_MOVE_STRENGTH] = FLAG_RECEIVED_HM04,
    [FIELD_MOVE_FLASH] = FLAG_RECEIVED_HM05,
    [FIELD_MOVE_ROCK_SMASH] = FLAG_RECEIVED_HM06,
    [FIELD_MOVE_WATERFALL] = FLAG_RECEIVED_HM07,
