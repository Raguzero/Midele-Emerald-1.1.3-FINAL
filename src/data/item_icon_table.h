const u32 *const gItemIconTable[][2] =
{
    ...
    [ITEM_G_PROTEIN] = {gItemIcon_Vitamin, gItemIconPalette_GProtein},
    [ITEM_G_IRON] = {gItemIcon_Vitamin, gItemIconPalette_GIron},
    [ITEM_G_CARBOS] = {gItemIcon_Vitamin, gItemIconPalette_GCarbos},
    [ITEM_G_CALCIUM] = {gItemIcon_Vitamin, gItemIconPalette_GCalcium},
    ...
    [ITEM_PINK_PETAL] = {gItemIcon_PinkPetal, gItemIconPalette_PinkPetal},
    [ITEM_PSYCHE_ARMOR] = {gItemIcon_PsycheArmor, gItemIconPalette_PsycheArmor},
    [ITEM_LEVEL_CAP] = {gItemIcon_LevelCap, gItemIconPalette_LevelCap},
