const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_CHAMPION_MIDELE] = _("{PKMN} CHAMPION"),
    ...
    [TRAINER_CLASS_DEBUG] = _("DEBUG"),
    [TRAINER_CLASS_PKMN_TRAINER_MIDELE] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_LEADER_MIDELE] = _("LEADER"),
