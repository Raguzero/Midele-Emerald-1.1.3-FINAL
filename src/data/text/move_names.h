const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BLOCK] = _("BLOCK"),
    [MOVE_HOWL] = _("HOWL"),
    [MOVE_DRAGON_CLAW] = _("DRAGON PULSE"),
...
// NUEVO MOVES
	...
	[MOVE_DAZZLING_GLEAM] = _("DAZZLING GL."),
    ...
    [MOVE_LIGHT_OF_RUIN] = _("LIGHT RUIN"),
    [MOVE_HEAD_SMASH] = _("HEAD SMASH"),
    [MOVE_HEAL_PULSE] = _("HEAL PULSE"),
    [MOVE_MIDELE_POWER] = _("MIDELE POWER"),
    ...
    [MOVE_DARK_THUNDER] = _("DARK THUNDER"),
    [MOVE_DRILL_RUN] = _("DRILL RUN"),
    [MOVE_LEAF_STORM] = _("LEAF STORM"),
    [MOVE_SHORE_UP] = _("SHORE UP"),
    [MOVE_DRAGON_HAMMER] = _("DRAGONHAMMER"),
    [MOVE_MONADO_POWER] = _("MONADO POWER"),
    [MOVE_BRUTAL_BALL] = _("BRUTAL BALL"),
    [MOVE_SEISMIC_PUNCH] = _("SEISMICPUNCH"),
    [MOVE_HOLA_REINA] = _("HOLA REINA"),
// NUEVO MOVES
};
