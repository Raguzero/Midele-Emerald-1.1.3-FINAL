const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_MEGA_BEEDRILL] =
    {
        .categoryName = _("POISON BEE"),
        .height = 14,
        .weight = 405,
        .description = gMegaBeedrillPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    },
    [NATIONAL_DEX_MEGA_PIDGEOT] =
    {
        .categoryName = _("BIRD"),
        .height = 22,
        .weight = 505,
        .description = gMegaPidgeotPokedexText,
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    },
    [NATIONAL_DEX_MEGA_BANETTE] =
    {
        .categoryName = _("MARIONETTE"),
        .height = 12,
        .weight = 130,
        .description = gMegaBanettePokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    },
    [NATIONAL_DEX_MEGA_SHARPEDO] =
    {
        .categoryName = _("BRUTAL"),
        .height = 25,
        .weight = 1303,
        .description = gMegaSharpedoPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 317,
        .trainerOffset = 3,
    },
    [NATIONAL_DEX_MEGA_CAMERUPT] =
    {
        .categoryName = _("ERUPTION"),
        .height = 25,
        .weight = 3205,
        .description = gMegaCameruptPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 345,
        .trainerOffset = 6,
    },
    [NATIONAL_DEX_MEGA_MAWILE] =
    {
        .categoryName = _("DECEIVER"),
        .height = 10,
        .weight = 235,
        .description = gMegaMawilePokedexText,
        .pokemonScale = 386,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
   ...
   [NATIONAL_DEX_THWACKEY] =
    ...
    [NATIONAL_DEX_G_KINGLER] =
    {
        .categoryName = _("PINCER"),
        .height = 13,
        .weight = 600,
        .description = gGKinglerPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_G_BUTTERFREE] =
    {
        .categoryName = _("BUTTERFLY"),
        .height = 11,
        .weight = 320,
        .description = gGButterfreePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GIGA_GARBODOR] =
    {
        .categoryName = _("TRASH HEAP"),
        .height = 19,
        .weight = 1073,
        .description = gGigaGarbodorPokedexText,
        .pokemonScale = 257,
        .pokemonOffset = 0,
        .trainerScale = 423,
        .trainerOffset = 8,
  ...
  [NATIONAL_DEX_PANSAGE] =
	...
	[NATIONAL_DEX_MAGNESANDS] =
	{
		.categoryName = _("MAGNET ZERO"),
		.height = 23,
		.weight = 600,
		.description = gMagnesandsPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
