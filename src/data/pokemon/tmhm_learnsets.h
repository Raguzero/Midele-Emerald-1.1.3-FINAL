...
// NUEVO PARA FORMAS ALOLA
 ...
 [SPECIES_ROSERADE]    = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
   ...
   [SPECIES_RILLABOOM]   = TMHM_LEARNSET(TMHM(TM06_TOXIC)
    ...
    [SPECIES_DREEPY]    = TMHM_LEARNSET(TMHM(TM40_AERIAL_ACE)
								| TMHM(TM06_TOXIC)),

    [SPECIES_DRAKLOAK]    = TMHM_LEARNSET(TMHM(TM40_AERIAL_ACE)
								| TMHM(TM06_TOXIC)),

    [SPECIES_DRAGAPULT]     = TMHM_LEARNSET(TMHM(TM40_AERIAL_ACE)
								| TMHM(TM06_TOXIC)),
