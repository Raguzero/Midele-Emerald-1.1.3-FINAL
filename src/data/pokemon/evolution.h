const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_BEEDRILL] = {{EVO_LEVEL, 8, SPECIES_MEGA_BEEDRILL}},
    ...
    [SPECIES_SHARPEDO]   = {{EVO_LEVEL, 45, SPECIES_MEGA_SHARPEDO}},
    ...
    [SPECIES_CAMERUPT]      = {{EVO_LEVEL, 45, SPECIES_MEGA_CAMERUPT}},
    ...
    [SPECIES_MAWILE]     = {{EVO_LEVEL, 36, SPECIES_MEGA_MAWILE}},
