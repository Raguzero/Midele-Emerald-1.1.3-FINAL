const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MAGNETON]  = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MAGNEZONE},
                            {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_MAGNESANDS}},
	...
	[SPECIES_PAWNIARD]	 = {{EVO_LEVEL, 44, SPECIES_BISHARP}},
    ...
    [SPECIES_APPLIN]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_FLAPPLE}, 
                            ...
                            {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_DIPPLIN}},							
	...
	[SPECIES_SKRELP]	 = {{EVO_LEVEL, 43, SPECIES_DRAGALGE}},
    ...
    [SPECIES_PRINPAWN] = {{EVO_LEVEL, 30, SPECIES_KINCURS},
						  {EVO_LEVEL_FEMALE, 30, SPECIES_COUREEN}},
    [SPECIES_NUMEL_LUCKY] =  {{EVO_LEVEL, 33, SPECIES_CAMERUPT_LUCKY}},
    [SPECIES_CAMERUPT_LUCKY]      = {{EVO_LEVEL, 50, SPECIES_MEGA_CAMERUPT_LUCKY}},
    [SPECIES_TRUBBISH]   = {{EVO_LEVEL, 36, SPECIES_GARBODOR}},
    [SPECIES_GARBODOR]   = {{EVO_ITEM_LEVEL_50, ITEM_METAL_COAT, SPECIES_GIGA_GARBODOR}},
    [SPECIES_PANSAGE]   = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_SIMISAGE}},
    [SPECIES_DURALUDON]   = {{EVO_ITEM_LEVEL_50, ITEM_DAWN_STONE, SPECIES_ARCHALUDON}},
    [SPECIES_WATTREL]   = {{EVO_LEVEL, 25, SPECIES_KILOWATTREL}},
    [SPECIES_DIPPLIN]   = {{EVO_ITEM_LEVEL_50, ITEM_DRAGON_SCALE, SPECIES_HYDRAPPLE}},
};
