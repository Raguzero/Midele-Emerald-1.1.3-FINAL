...
static const u16 sLedybaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(39, MOVE_RECOVER), // --> Similar a ROOST
...
static const u16 sSunfloraLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(36, MOVE_ENDEAVOR),
    LEVEL_UP_MOVE(40, MOVE_PETAL_DANCE),
    LEVEL_UP_MOVE(43, MOVE_QUIVER_DANCE), // Nuevo movimiento exclusivo de MIDELE
    LEVEL_UP_MOVE(47, MOVE_HEAT_WAVE), // Nuevo movimiento exclusivo de MIDELE
    LEVEL_UP_END
};
