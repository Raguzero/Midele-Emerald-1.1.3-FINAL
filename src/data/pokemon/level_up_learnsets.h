...
static const u16 sDarkPikachuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(53, MOVE_OUTRAGE),
    LEVEL_UP_MOVE(58, MOVE_DARK_THUNDER),
    LEVEL_UP_MOVE(66, MOVE_NASTY_PLOT),
    LEVEL_UP_MOVE(73, MOVE_BRUTAL_BALL),
    LEVEL_UP_MOVE(99, MOVE_MIDELE_POWER),
    LEVEL_UP_END
};
...
static const u16 sHonedgeMonadoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(90, MOVE_MONADO_POWER),
    LEVEL_UP_END
};