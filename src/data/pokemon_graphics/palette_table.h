...
// NUEVO POKES
    ...
    SPECIES_PAL(GALAR_WEEZING, gMonPalette_GalarWeezing),
    SPECIES_PAL(GALAR_MEOWTH, gMonPalette_GalarMeowth),
    SPECIES_PAL(PERSERKER, gMonPalette_Perserker),
    SPECIES_PAL(GALAR_ZIGZAGOON, gMonPalette_GalarZigzagoon),
    SPECIES_PAL(GALAR_LINOONE, gMonPalette_GalarLinoone),
    SPECIES_PAL(OBSTAGOON, gMonPalette_Obstagoon),
    SPECIES_PAL(GALAR_FARFETCH, gMonPalette_GalarFarfetch),
    SPECIES_PAL(SIRFETCH, gMonPalette_Sirfetch),
    SPECIES_PAL(GALAR_CORSOLA, gMonPalette_GalarCorsola),
    SPECIES_PAL(CURSOLA, gMonPalette_Cursola),
    SPECIES_PAL(GALAR_PONYTA, gMonPalette_GalarPonyta),
    SPECIES_PAL(GALAR_RAPIDASH, gMonPalette_GalarRapidash),
    SPECIES_PAL(GALAR_MRMIME, gMonPalette_GalarMrmime),
    ...
    SPECIES_PAL(GALAR_YAMASK, gMonPalette_Galar_Yamask),
    ...
    SPECIES_PAL(MEGA_ABOMASNOW, gMonPalette_Mega_Abomasnow),
    SPECIES_PAL(MEGA_GLALIE, gMonPalette_Mega_Glalie),
    ...
    SPECIES_PAL(TOXTRICITY_LK, gMonPalette_Toxtricity_lk),
    ...
    SPECIES_PAL(G_KINGLER, gMonPalette_gKingler),
    SPECIES_PAL(G_BUTTERFREE, gMonPalette_gButterfree),
    ...
    SPECIES_PAL(LYCANROC_DAY, gMonPalette_Lycanrocday),
    SPECIES_PAL(LYCANROC_NIGHT, gMonPalette_Lycanrocnight),
    ...
    SPECIES_PAL(SLIGGOO, gMonPalette_Sligoo),
    SPECIES_PAL(GOODRA, gMonPalette_Goodra),
    SPECIES_PAL(STUNFISK, gMonPalette_Stunfisk),
    SPECIES_PAL(GALAR_STUNFISK, gMonPalette_Galar_Stunfisk),
    ...
    SPECIES_PAL(DARK_PIKACHU, gMonPalette_Dark_Pikachu),
    SPECIES_PAL(ARMOR_MEWTWO, gMonPalette_Armor_Mewtwo),
    SPECIES_PAL(HONEDGE_MONADO, gMonPalette_Honedge_Monado),
// NUEVOS POKES
    ...
    SPECIES_PAL(GIGA_GARBODOR, gMonPalette_GigaGarbodor),
...
{
    SPECIES_PAL(JELLICENT, gMonPalette_Jellicent_Female),
    SPECIES_PAL(FRILLISH, gMonPalette_Frillish_Female),
};
