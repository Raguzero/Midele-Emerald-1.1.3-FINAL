...
// NUEVO POKES
    ...
    SPECIES_SPRITE(GALAR_WEEZING, gMonBackPic_GalarWeezing),
    SPECIES_SPRITE(GALAR_MEOWTH, gMonBackPic_GalarMeowth),
    SPECIES_SPRITE(PERSERKER, gMonBackPic_Perserker),
    SPECIES_SPRITE(GALAR_ZIGZAGOON, gMonBackPic_GalarZigzagoon),
    SPECIES_SPRITE(GALAR_LINOONE, gMonBackPic_GalarLinoone),
    SPECIES_SPRITE(OBSTAGOON, gMonBackPic_Obstagoon),
    SPECIES_SPRITE(GALAR_FARFETCH, gMonBackPic_GalarFarfetch),
    SPECIES_SPRITE(SIRFETCH, gMonBackPic_Sirfetch),
    SPECIES_SPRITE(GALAR_CORSOLA, gMonBackPic_GalarCorsola),
    SPECIES_SPRITE(CURSOLA, gMonBackPic_Cursola),
    SPECIES_SPRITE(GALAR_PONYTA, gMonBackPic_GalarPonyta),
    SPECIES_SPRITE(GALAR_RAPIDASH, gMonBackPic_GalarRapidash),
    SPECIES_SPRITE(GALAR_MRMIME, gMonBackPic_GalarMrmime),
    SPECIES_SPRITE(MRRIME, gMonBackPic_Mrrime),
    ...
    SPECIES_SPRITE(GALAR_YAMASK, gMonBackPic_Galar_Yamask),
    ...
    SPECIES_SPRITE(MEGA_ABOMASNOW, gMonBackPic_Mega_Abomasnow),
    SPECIES_SPRITE(MEGA_GLALIE, gMonBackPic_Mega_Glalie),
    ...
    SPECIES_SPRITE(TOXTRICITY_LK, gMonBackPic_Toxtricity_lk),
    ...
    SPECIES_SPRITE(G_KINGLER, gMonBackPic_gKingler),
    SPECIES_SPRITE(G_BUTTERFREE, gMonBackPic_gButterfree),
    ...
    SPECIES_SPRITE(LYCANROC_DAY, gMonBackPic_Lycanrocday),
    SPECIES_SPRITE(LYCANROC_NIGHT, gMonBackPic_Lycanrocnight),
    ...
    SPECIES_SPRITE(SLIGGOO, gMonBackPic_Sligoo),
    SPECIES_SPRITE(GOODRA, gMonBackPic_Goodra),
    SPECIES_SPRITE(STUNFISK, gMonBackPic_Stunfisk),
    SPECIES_SPRITE(GALAR_STUNFISK, gMonBackPic_Galar_Stunfisk),
    ...
    SPECIES_SPRITE(TAUROS_PALDEAN_FIGHT, gMonBackPic_TaurosFight),
    ...
    SPECIES_SPRITE(GIGA_GARBODOR, gMonBackPic_GigaGarbodor),
...
{
    SPECIES_SPRITE(JELLICENT, gMonBackPic_Jellicent_Female),
    SPECIES_SPRITE(FRILLISH, gMonBackPic_Frillish_Female),
};
