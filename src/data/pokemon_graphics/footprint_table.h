...
// NUEVO PARA FORMAS ALOLA
    ...
    [SPECIES_ALOLAN_SANDSHREW] = gMonFootprint_AlolanSandshrew,
    [SPECIES_ALOLAN_SANDSLASH] = gMonFootprint_AlolanSandslash,
    [SPECIES_ALOLAN_VULPIX] = gMonFootprint_AlolanVulpix,
    [SPECIES_ALOLAN_NINETALES] = gMonFootprint_AlolanNinetales,
    [SPECIES_ALOLAN_DIGLETT] = gMonFootprint_AlolanDiglett,
    [SPECIES_ALOLAN_DUGTRIO] = gMonFootprint_AlolanDugtrio,
    [SPECIES_ALOLAN_MEOWTH] = gMonFootprint_AlolanMeowth,
    [SPECIES_ALOLAN_PERSIAN] = gMonFootprint_AlolanPersian,
    [SPECIES_ALOLAN_GEODUDE] = gMonFootprint_AlolanGeodude,
    [SPECIES_ALOLAN_GRAVELER] = gMonFootprint_AlolanGraveler,
    [SPECIES_ALOLAN_GOLEM] = gMonFootprint_AlolanGolem,
    [SPECIES_ALOLAN_GRIMER] = gMonFootprint_AlolanGrimer,
    [SPECIES_ALOLAN_MUK] = gMonFootprint_AlolanMuk,
    [SPECIES_ALOLAN_EXEGGUTOR] = gMonFootprint_AlolanExeggutor,
    [SPECIES_ALOLAN_MAROWAK] = gMonFootprint_AlolanMarowak,
    [SPECIES_MEGA_BEEDRILL] = gMonFootprint_MegaBeedrill,
    [SPECIES_MEGA_PIDGEOT] = gMonFootprint_MegaPidgeot,
    [SPECIES_MEGA_BANETTE] = gMonFootprint_MegaBanette,
    [SPECIES_MEGA_SHARPEDO] = gMonFootprint_MegaSharpedo,
    [SPECIES_MEGA_CAMERUPT] = gMonFootprint_MegaCamerupt,
    [SPECIES_MEGA_MAWILE] = gMonFootprint_MegaMawile,
    [SPECIES_GALAR_WEEZING] = gMonFootprint_GalarWeezing,
    [SPECIES_GALAR_MEOWTH] = gMonFootprint_GalarMeowth,
    [SPECIES_PERSERKER] = gMonFootprint_Perserker,
    [SPECIES_GALAR_ZIGZAGOON] = gMonFootprint_GalarZigzagoon,
    [SPECIES_GALAR_LINOONE] = gMonFootprint_GalarLinoone,
    [SPECIES_OBSTAGOON] = gMonFootprint_Obstagoon,
    [SPECIES_GALAR_FARFETCH] = gMonFootprint_GalarFarfetch,
    [SPECIES_SIRFETCH] = gMonFootprint_Sirfetch,
    [SPECIES_GALAR_CORSOLA] = gMonFootprint_GalarCorsola,
    [SPECIES_CURSOLA] = gMonFootprint_Cursola,
    [SPECIES_GALAR_PONYTA] = gMonFootprint_GalarPonyta,
	...
	[SPECIES_MEGA_HOUNDOOM] = gMonFootprint_MegaHoundoom,
    [SPECIES_MEGA_SABLEYE] = gMonFootprint_MegaSableye,
    [SPECIES_MEGA_ALTARIA] = gMonFootprint_MegaAltaria,
    [SPECIES_MEGA_ABSOL] = gMonFootprint_MegaAbsol,
    [SPECIES_MEGA_ABOMASNOW] = gMonFootprint_MegaAbomasnow,
    ...
    [SPECIES_GIGA_GARBODOR] = gMonFootprint_GigaGarbodor,
