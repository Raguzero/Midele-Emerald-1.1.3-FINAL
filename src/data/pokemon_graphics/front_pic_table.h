...
// NUEVO POKES
    ...
    SPECIES_SPRITE(SLIGGOO, gMonFrontPic_Sligoo),
    SPECIES_SPRITE(GOODRA, gMonFrontPic_Goodra),
    SPECIES_SPRITE(STUNFISK, gMonFrontPic_Stunfisk),
    SPECIES_SPRITE(GALAR_STUNFISK, gMonFrontPic_Galar_Stunfisk),
    ...
    SPECIES_SPRITE(DARK_PIKACHU, gMonFrontPic_Dark_Pikachu),
    SPECIES_SPRITE(ARMOR_MEWTWO, gMonFrontPic_Armor_Mewtwo),
    SPECIES_SPRITE(HONEDGE_MONADO, gMonFrontPic_Honedge_Monado),
	// NUEVO POKES
    ...
    SPECIES_SPRITE(NUMEL_LUCKY, gMonFrontPic_NumelLucky),
    SPECIES_SPRITE(CAMERUPT_LUCKY, gMonFrontPic_CameruptLucky),
    SPECIES_SPRITE(MEGA_CAMERUPT_LUCKY, gMonFrontPic_MegaCameruptLucky),
	SPECIES_SPRITE(TRUBBISH, gMonFrontPic_Trubbish),
    SPECIES_SPRITE(GARBODOR, gMonFrontPic_Garbodor),
    SPECIES_SPRITE(GIGA_GARBODOR, gMonFrontPic_GigaGarbodor),
