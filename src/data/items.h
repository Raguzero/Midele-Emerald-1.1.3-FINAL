...
// Pokeballs
    ...
    [ITEM_MASTER_BALL] =
    {
        ...
        .type = 0,
        .battleUsage = ITEM_BATTLE_USAGE_UNUSABLE_BOSS_BATTLE,
...
// Medicine
    ...
    [ITEM_BLUE_FLUTE] =
    {
        ...
        .price = 100,
        .holdEffect = HOLD_EFFECT_BLUE_FLUTE,
    ...
    [ITEM_YELLOW_FLUTE] =
    {
        ...
        .price = 200,
        .holdEffect = HOLD_EFFECT_YELLOW_FLUTE,
    ...
    [ITEM_RED_FLUTE] =
    {
        ...
        .price = 300,
	    .holdEffect = HOLD_EFFECT_RED_FLUTE,
...
// Battle items
    ...
    [ITEM_POKE_DOLL] =
    {
        ...
        .price = 1000,
        .holdEffect = HOLD_EFFECT_POKE_DOLL,
    ...
    [ITEM_FLUFFY_TAIL] =
    {
        ...
        .price = 1000,
        .holdEffect = HOLD_EFFECT_FLUFFY_TAIL,
...
// Valuable items
    ...
    [ITEM_TINY_MUSHROOM] =
    {
        ...
        .price = 500,
        .holdEffect = HOLD_EFFECT_TINY_MUSHROOM,
    ...
    [ITEM_BIG_MUSHROOM] =
    {
        ...
        .price = 5000,
        .holdEffect = HOLD_EFFECT_BIG_MUSHROOM,
...
// Hold items
    ...
    {
        .name = _("PSYCHE ARMOR"),
        .itemId = ITEM_PSYCHE_ARMOR,
        .price = 0,
        .description = sPsycheArmorDesc,
		.importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = 1,
